    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-140px)] px-4 py-12 relative overflow-hidden text-[#f5f5f5]">
      <div className="w-full max-w-md bg-[#111111] p-8 sm:p-10 rounded-2xl shadow-xl border border-[#222222] relative">
        ...
        <div className="text-center mb-8 space-y-2">
          <div className="inline-flex h-12 w-12 rounded-xl bg-[#161616] border border-[#262626] items-center justify-center text-[#bbf451] mb-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="block text-xs font-bold text-[#a3a3a3] uppercase tracking-wider">
                Password
              </label>
            </div>
            <div className="relative">
        ...
        <div className="mt-8 pt-6 border-t border-[#222222] text-center">
          <p className="text-xs text-[#737373]">
            ...
            <Link to="/register" className="text-[#bbf451] font-semibold hover:underline">
              Create free account
            </Link>
          </p>
        </div>
